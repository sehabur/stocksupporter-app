...
export default function TradingviewChart() {
  ...
  dispatch(pageTitleActions.setPageTitle("Superchart"));
    ...
    var widget = (window.tvWidget = new tvWidget.widget({
      ...
      save_load_adapter: {
        ...
        getAllCharts: async function () {
          ...
          try {
            const res = await fetch(
              `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/tvcharts/chart?getType=all`,
              {
                method: "GET",
                headers: {
        ...
        removeChart: async function (chartId: any) {
          ...
          try {
            const res = await fetch(
              `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/tvcharts/chart?id=${chartId}`,
              {
                method: "DELETE",
                headers: {
                  "Content-Type": "application/json",
        ...
        saveChart: async function (chartData: { id: string }) {
          ...
          try {
            const res = await fetch(
              `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/tvcharts/chart`,
              {
                method: "POST",
                headers: {
                  "Content-Type": "application/json",
        ...
        getChartContent: async function (chartId: any) {
          ...
          try {
            const res = await fetch(
              `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/tvcharts/chart?getType=content&id=${chartId}`,
              {
                method: "GET",
                headers: {
                  "Content-Type": "application/json",
        ...
        removeStudyTemplate: async function (studyTemplateData: { name: any }) {
          ...
          try {
            const res = await fetch(
              `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/tvcharts/template?name=${studyTemplateData.name}`,
              {
                method: "DELETE",
                headers: {
                  "Content-Type": "application/json",
        ...
        getStudyTemplateContent: async function (studyTemplateData: {
          ...
          try {
            const res = await fetch(
              `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/tvcharts/template?getType=content&name=${studyTemplateData.name}`,
              {
                method: "GET",
                headers: {
                  "Content-Type": "application/json",
        ...
        saveStudyTemplate: async function (studyTemplateData: {}) {
          ...
          try {
            const res = await fetch(
              `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/tvcharts/template`,
              {
                method: "POST",
                headers: {
                  "Content-Type": "application/json",
        ...
        getAllStudyTemplates: async function () {
          ...
          try {
            const res = await fetch(
              `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/tvcharts/template?getType=all`,
              {
                method: "GET",
                headers: {
                  "Content-Type": "application/json",
